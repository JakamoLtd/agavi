...
class AgaviConfigCache
{
	 ...
	 */
	protected static array $checkedConfigCache = [];
	...
	public static function getCacheName($config, $context = null)
	{
		...
		$result = $baseCacheDir . DIRECTORY_SEPARATOR . self::CACHE_SUBDIR . DIRECTORY_SEPARATOR . $cacheName;
